              ...
              Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: <Widget>[
                ...
                ...List<Widget>.generate(
                  ...
                  (int index) {
                    ...
                    return IconButton(
                      icon:
                          selectedColor == ColorSeed.values[index].color ? Icon(Icons.circle, color: itemColor) : Icon(Icons.circle_outlined, color: itemColor),
                      onPressed: () {
                        setState(() {
      ...
      onPressed: () {
        showModalBottomSheet<void>(
          ...
          builder: (BuildContext context) {
            return Settings(selectedColor: selectedColor, selectedBrightness: selectedBrightness, selectedContrast: selectedContrast, updateTheme: updateTheme);
          },
        );
      },
    );
